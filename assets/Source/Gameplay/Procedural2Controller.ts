...
export class Procedural2Controller extends Component {
    ...
    private _applyInput(deltaTime: number) {
        //const forwardInput = 1;//globalInputManager.getAxisValue(PredefinedAxisId.MoveForward);
        //const rightInput = 1;//globalInputManager.getAxisValue(PredefinedAxisId.MoveRight);
        //const inputVector = new Vec3(-rightInput, 0.0, forwardInput);
        const inputVector = new Vec3(this.dir);
